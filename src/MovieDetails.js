			...
			<div className="movie-details">
				...
				<main className="movie-info">
					...
					<span> {this.props.movieDetails.movieDetails.Year }
						...
						{	
							this.props.movieDetails.movieDetails.Runtime == "N/A"
							? "No Runtime available"
							: this.props.movieDetails.movieDetails.Runtime
						} 
						<span className="separator">|</span> 
						{	
							this.props.movieDetails.movieDetails.Genre == "N/A"
							? "No genre available"
					...
					<section className="rating">
						{ this.props.movieDetails.movieDetails.imdbRating && this.props.movieDetails.movieDetails.imdbRating != "N/A"
							? <Rating rating={this.props.movieDetails.movieDetails.imdbRating} />
							: null
						}
						
						<span className="number-rating"> {
							this.props.movieDetails.movieDetails.imdbRating == "N/A"
							? " - "
							: this.props.movieDetails.movieDetails.imdbRating
						} / 10</span>
					</section>

					<h5 className="synopsis-title">Sinopse</h5>
					<p className="movie-synopsis">
						{this.props.movieDetails.movieDetails.Plot == "N/A" 
							? "No plot available"
							: this.props.movieDetails.movieDetails.Plot
						}
					</p>
