...
const Rating = ({rating = 6}) => (
  <section>   
	
	{ /* first render filled stars */ 
		[...Array(Math.ceil(rating/2))].map(
			(e, key) => 
			<svg xmlns='http://www.w3.org/2000/svg' key={key} className="filled-star" xmlnsXlink='http://www.w3.org/1999/xlink'
	...
	{ /*the rest are hollow stars */
		[...Array(5-Math.ceil(rating/2))].map(
					(e, key) => 
					<svg xmlns='http://www.w3.org/2000/svg' key={key} className="hollow-star" xmlnsXlink='http://www.w3.org/1999/xlink'
					width='22' height='22' viewBox='0 0 22 22'>
					    <defs>
